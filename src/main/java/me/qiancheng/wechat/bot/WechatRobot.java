...
import me.qiancheng.wechat.bot.listener.WechatListener;
import me.qiancheng.wechat.bot.model.WechatMeta;
import me.qiancheng.wechat.bot.service.WechatService;
import me.qiancheng.wechat.bot.service.WechatServiceImpl;
import me.qiancheng.wechat.bot.ui.QRCodeFrame;
import me.qiancheng.wechat.bot.util.CookieUtil;
...
public class WechatRobot {
	...
	public String waitForLogin() throws WechatException {
		...
		if (null == code) {
			...
			if (code.equals("201")) {
				...
				String baseUri = redirect_uri.substring(0, redirect_uri.lastIndexOf("/"));
	...
	private void showQrCodeInConsole(String url) {
